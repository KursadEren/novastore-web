    ...
    <>
      ...
      `}>
        ...
        <nav className="mt-8 flex flex-col gap-2">
          ...
          {/* Animation Test - Geliştirme için */}
          <div className="mt-4 pt-4 border-t border-white/20">
            <NavLink to="/animation-test" onClick={() => setIsOpen(false)} className={({ isActive }) =>
              `p-3 rounded-lg text-white transition-all duration-200 ${isActive ? "bg-amber-500/30 shadow-lg" : "hover:bg-amber-500/20 hover:translate-x-2"}`
            }>
              <span className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
